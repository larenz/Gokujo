...
//($this->error->getCode() == '404') { header('Location: /index.php?option=com_content&view=article&id=15'); exit; }
if ($this->error->getCode() == '404') { header('Location: /index.php?option=com_content&view=article&id=15'); exit; }
