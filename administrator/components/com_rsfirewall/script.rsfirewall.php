...
.com-rsfirewall-button {
	...
	<div id="installer-right">
		...
		<h2>Changelog v2.8.4</h2>
		<ul class="version-history">
			<li><span class="version-new">New</span> Whois service for IPv4 can now be configured instead of the default 'http://whois.domaintools.com'.</li>
			<li><span class="version-new">New</span> A separate Whois service for IPv6 can now be configured.</li>
			<li><span class="version-new">New</span> Warning message shows up when 'Disable the creation of new Administrators' is active and you're editing a user in User Manager.</li>
			<li><span class="version-upgraded">Upg</span> Logging more events (if it's enabled) when performing the System Check to aid during debugging.</li>
			<li><span class="version-fixed">Fix</span> In some cases, the JSON result returned by the System Check couldn't be decoded.</li>
			<li><span class="version-fixed">Fix</span> Country Flag did not appear in the System Overview page.</li>
			<li><span class="version-fixed">Fix</span> Country Flag did not appear in the RSFirewall! Control Panel Module.</li>
		</ul>
